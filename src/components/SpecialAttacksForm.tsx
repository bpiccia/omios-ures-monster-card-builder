...
interface SpecialAttacksFormProps {
	...
	readonly updateSpecialAttack: (
		id: string,
		updates: Partial<Omit<SpecialAttack, "id">>
	) => void
					...
					>
						<div className="flex gap-2">
							<input
								...
								onChange={(e) =>
									updateSpecialAttack(specialAttack.id, {
										name: e.target.value,
									})
								}
						...
						<textarea
							...
							onChange={(e) =>
								updateSpecialAttack(specialAttack.id, { desc: e.target.value })
							}
